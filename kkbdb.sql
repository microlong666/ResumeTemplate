CREATE DATABASE IF NOT EXISTS `kkbdb` DEFAULT CHARSET utf8mb4 COLLATE utf8mb4_general_ci;
...
(
    ...
    `start`       varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   DEFAULT NULL COMMENT '开始时间',
    `end`         varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   DEFAULT NULL COMMENT '结束时间',
    `school`      varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   DEFAULT NULL COMMENT '学校',
    `study`       varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   DEFAULT NULL COMMENT '专业名称',
  ...
  ROW_FORMAT = DYNAMIC COMMENT ='用于描述用户的学习';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='用户技能表';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='用于描述用户特长';
...
(
    ...
    `description` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '个人简介',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='用户基础信息表，包含了用户的基本信息';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='用于描述用户的工作经历';
